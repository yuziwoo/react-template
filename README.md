...
- PC 디자인은 1920px 기준이며 1rem을 12px로 지정하였습니다. 웹 최소 폰트 사이즈 10px으로 인해 반응형 최소 폰트는 1.5rem (18px)입니다.
- MOB 디자인은 1080px 기준이며 1rem을 12px로 지정하였습니다. 앱 최소 폰트 사이즈 10px으로 인해 반응형 최소 폰트는 3.2rem (38.4px)입니다.
